...
class Form {
    ...
    protected static function parse_attributes( $attributes = [] ) {
        return shortcode_atts(
            array(
                'heading_text' => __( 'We can buy your car today!', MCT_TEXT_DOMAIN ),
                'intro_text'   => __( 'Get your free valuation by completing this quick form.', MCT_TEXT_DOMAIN ),
                'button_text'  => __( 'Get Your Free Valuation', MCT_TEXT_DOMAIN ),
